...
### Главная страница - Статистика по очередям
![Главная страница](screen/screen1.png)
*Dashboard с ключевыми метриками и графиками распределения звонков по часам*

### Детальный лог звонков
![Детальный лог](screen/screen2.png)
*Таблица со всеми звонками, возможностью прослушивания записей и фильтрации*

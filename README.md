...
| `GET` | `/api/recording/:uniqueid` | Скачать аудиозапись звонка |
| `GET` | `/api/recording/:uniqueid/info` | Получить метаданные записи звонка |
...
curl http://localhost:3000/api/recording/1768478301.261093/info

# Скачать запись звонка
curl -O http://localhost:3000/api/recording/1768478301.261093
```

#### API для записей звонков

Получение записей звонков по уникальному идентификатору (`uniqueid`):
...
```json
{
  "success": true,
  "call": {
    "uniqueid": "1768478301.261093",
    "calldate": "2026-01-15 14:58:21",
    "from": "1215",
    "to": "+79101326917",
    "duration": 13,
    "billsec": 11,
  ...
  "recording": {
    "filename": "out-+79101326917-1215-20260115-145823-1768478301.261093.mp3",
    "size": 47647,
    "sizeFormatted": "0.05 MB",
    "downloadUrl": "/api/recording/1768478301.261093",
    "exists": true
  }
}
```
...
# В JavaScript
window.location.href = '/api/recording/1768478301.261093';
```

> 💡 **Примечание**: `uniqueid` можно найти в таблице детального лога звонков на странице аналитики.
...
Проект использует [Cursor Rules](https://cursor.com/docs/context/rules) для стандартизации разработки и помощи AI-ассистенту.
...
1. Правила применяются автоматически при работе с соответствующими файлами
2. Можно упомянуть правило вручную: `@api-routes`, `@database-patterns`, и т.д.
3. Все правила версионируются в Git и доступны всей команде

Подробнее: [Cursor Rules Documentation](https://cursor.com/docs/context/rules)
